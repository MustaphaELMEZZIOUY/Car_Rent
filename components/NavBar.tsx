...
import { itemsLinks } from '../constant'
// import { itemsLinks } from '../constant/menuItemsLinks'
      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <Link
          href={{
            ...
            query: { search_query: 'car+rental+website+project' },
          }}
        >
          <a className="flex items-center">
            <Image src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-6 sm:h-9" width="35" height="35" alt="Flowbite Logo" />
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white ml-1">Flowbite</span>
          </a>
        </Link>
